...
<head>
    ...
    <title>Aya Store | Admin login</title>
    ...
    <div class="navbar-inner" style="background-color: #12CCA7">
        <div class="container">
            ...
            <a class="brand" href="..\index.php" >
                <b style="font-family:Jokerman;color: #9d2954; font-size: 30px;">Aya Store</b> | Control panel
            </a>
...
<!--
<div class="footer" style="background-color: #1d1f21">
    <div class="container"style="font-family: Andalus;
        font-weight: bold;
        text-align: center;
        margin-top: 40px;">
        <b class="copyright" style="color: darkgrey">SVU-GROUP 2020 &copy;</b> All Rights Reserved.
    </div>
</div>
-->
