...
<div class="controls" style="padding-left: 115px; width:78%;">
<textarea  name="productDescription"  placeholder="Enter Product Description" rows="3" class="span8 tip"><?php echo htmlentities($row['productDescription']);?></textarea>
</div>
</div>
