                ...
                <div class="content" >
                    ...
                    <div class="module">
                        <div class="module-head" style=" background-color:#12cca7">
                            <button style="cursor: pointer;border:0px;background-color: whitesmoke;padding: 14px 28px; style" onclick="showing()">
                        ...
                        <div class="module-body">
                            ...
                            <form style="display: none;" id="Hide/Show" class="form-horizontal row-fluid" name="chngpwd" method="post" onSubmit="return valid();">
