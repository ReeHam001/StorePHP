...
<div class="container">
 <div class="row">
      ...
      <div class="col-xs-12 col-sm-12 col-md-3 logo-holder">
        ...
        <div class="logo">
            <a href="index.php">
                <h2 style="font-family:Jokerman;margin-top:-3.5px;padding-left: 10px;padding-top: 3px;color: #9d2954;width: 180px;height:47px ">
                Aya Store
                </h2>
            </a>
        </div>
...
<div class="search-area" style=" height:47px; border-radius: 4px;">
    <form name="search" method="post" action="search-result.php">
        <div class="control-group">

            <input style="border:none;" class="search-field" placeholder="What are you looking for?" name="product" required="required" />

            <button class="search-button" type="submit" name="search" style=" border: none; background-color: #fff;" ></button>
	...
	<div class="dropdown dropdown-cart">
		<a href="#" class="dropdown-toggle lnk-cart" data-toggle="dropdown" >
			<div class="items-cart-inner">
				...
				<div class="basket" style="background-color:#FFFFFF;">
